 ...
 * 请求返回自动校验
 ============================================*/
    ...
    Requester.JSONP = function (url, params) {
        ...
        args.push(Object.prototype.toString.call(params.callback) === '[object String]' ? 'callback=' + params.callback : 'callback=window.Requester.jsonproxy_callback("' + proxy['id'] + '").callback');
