    ...
    function displayTime(g, c) {
        ...
        if (c.hasHover) {
            $(g).parent().bind({
                mouseover: function () {
                    $(g).css({
                        'backgroundImage': 'url(' + c.sprite.replace('icon-clock-small.png', 'icon-clock-small-white.png') + ')',
                        'backgroundPosition': '-' + x + 'px -' + y + 'px'
                    });
                },
                mouseleave: function () {
                    $(g).css({
                        'backgroundImage': 'url(' + c.sprite.replace('icon-clock-small-white.png', 'icon-clock-small.png') + ')',
                        'backgroundPosition': '-' + x + 'px -' + y + 'px'
                    });
                }
            });
