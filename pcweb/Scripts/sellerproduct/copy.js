    ...
    KISSY.ready(function (S) {
        ...
        k.on("dataReady", function () {
            j$("#Button1").click(function () {
                ...
                j$("#ProductProperty").val(j$("#CopyProductPropertyDiv *").serialize());
...
j$(function () {
    ...
    $('a.buttonCancelAmendCatalog').live('click', function () {
        ...
        $(this).parent().parent().find('.manuSKU').attr('disabled', 'disabled');
        $(this).prev().show();
        $(this).hide();
