Ymt.add(function (require, exports, module) {
    ...
    if (window.ActiveXObject){
        ...
        if(Sys.ie == 6){
            ...
            $(".countries .item").live("mouseover",function(){
                $(this).addClass("hover");
            });
            $(".countries .item").live("mouseleave",function(){
                $(this).removeClass("hover");
            });      
        }
    }
    function ie6Hover(obj,classname){
        $(obj).live("mouseover",function(){
            $(this).addClass("top-dropdown-ie6");
        });
        $(obj).live("mouseleave",function(){
            $(this).removeClass("top-dropdown-ie6");
        });
    }
