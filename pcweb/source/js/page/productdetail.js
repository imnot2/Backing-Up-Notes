define(function (require, exports, module) {
    ...
    var tabs = require("../module/widget/tabs");
    var ellipsis = require("../module/util/ellipsis");
    //规格
    var specifi = require("../temp/specification");
    //轮播图
    var slide = require("../module/widget/slide");
    //cookie
    var cookie = require("../module/util/cookie");
    //paused
    var CountDown = require('../module/widget/countdown');
    var imglazyload = require("../module/util/imglazyload");
    var pagination = require('../temp/pagination');
    var LayerBox = require("../module/widget/layerbox");

    var filterhtml = require("../module/util/html");
    ...
    */
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                filter.closeTags();
                filter.filter('link', 'script', 'key');
                $('#proShow').html(filter.innerHTML());
    ...
    $(function () {
        ...
        $('.productInvitediv .inviteBox').bind("mouseenter", function () {
            $(this).find('.shareIconBox').show();
        });
        $('.productInvitediv .inviteBox').bind("mouseleave", function () {
            $(this).find('.shareIconBox').hide();
        });
    });
});