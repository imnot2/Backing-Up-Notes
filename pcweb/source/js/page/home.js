define(function (require, exports, module) {
    var JSON = require('../module/ui/json');
    try {
        if (IsVoteShow) {
    ...
    require("../module/util/imglazyload")("#HomePageContent");
    ...
    var Infinitescroll = require('../module/widget/infinitescroll');
