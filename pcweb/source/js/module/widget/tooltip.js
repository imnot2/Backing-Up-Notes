define(function (require, exports, module) {
    ...
    function E(a) {
        var b = this.config = $m.merge(w.config, a || {}),
            f = u;
    ...
    u.find = function (e, j) {
        function a(e) {
            for (var c = 0; c < e.length; c++) {
                ...
                if (k.nodeType == 1) {
                    if (d == ".")
                        if (k.className.split(" ").length == 1) k.className == j.split(".")[1] && b.push(k);
                        else
                            for (var f = k.className.split(" "), g = 0; g < f.length; g++) f[g] == j.split(".")[1] && b.push(k);
    ...
    u.struc = function (a) {
        ...
        ins.closecls && t.bind(ins.closecls, 'click', function () {
            that.display(ins, !1)
        });
    }
    u.r = function (str) {
